...
namespace lab1_obj_parser
{
    public class Model
    {
        ...
        public List<Vec4> Normals { get; private set; } = new List<Vec4>(); // Список всех нормалей из файла

        // Теперь Face будет хранить не просто индексы вершин, а пары (индекс вершины, индекс нормали)
