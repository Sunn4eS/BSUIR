...
namespace lab1_obj_parser
{
    public class Model
    {
        ...
        public List<Vec2> UVs { get; private set; } = new List<Vec2>();
        ...
        private void ParseMtl(string mtlPath, string baseDir)
        {
            ...
            foreach (var line in lines)
            {
                ...
                else if (type == "map_ks" && SpecularMapPath == null) SpecularMapPath = fullPath;
                else if ((type == "bump" || type == "map_bump") && NormalMapPath == null) NormalMapPath = fullPath;
            }
        }
    }
}