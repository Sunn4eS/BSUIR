...
Begin
    ...
    ListsActionForm.TitleLabel.Width := 300;
...
Begin
    CreateModalForm('Инструкция', 'Список кандидатов:'#13#10 +
      ...
      + 'Файлы:'#13#10 + '1. Файл имеет расширение .ea'#13#10#13#10 +
      'Поиск:'#13#10 +
      'Для использования поиска введите название партии и нажмите кнопку "Найти".'#13#10#13#10
