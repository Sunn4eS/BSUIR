...
Begin
    ...
    Begin
        ...
        Begin
            If Marks[Logic] < 4 Then // CurrStudent^.Data.Marks[Logic] < 4
                Inc(Count);
...
Begin
    ...
    While CurrStudent <> Nil Do
    Begin
        // Срхранение удаляемого студента
        ...
        Dispose(TempStudent);
    End;
    // Разрывание связи указателя списка
    StudentList := Nil;
End;
...
Begin
    ...
    If StudentList = Nil Then
        ...
        // Eсли список до этого имел элементы
    Else
    Begin
        ...
        While CurrStudent^.Next <> Nil Do
            CurrStudent := CurrStudent^.Next;
        // Добавление нового студента в конец списка
