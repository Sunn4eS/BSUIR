...
begin
    TaskLabel.Caption := 'Данная программа выясняет можно ли представить N в виде' + #13#10 + 'произведения трех последовательных натуральных чисел:';
...
Procedure MainAlgorithm(N: Integer);
Var
    Mult: Double;
    I: Integer;
    IsGood : Boolean;
Begin
    ...
    End;
    if N = Mult then
        mainTaskForm.OutEdit.Text := 'Можно представить'
    Else
        mainTaskForm.OutEdit.Text := 'Нельзя представить'
