object MainTaskForm: TMainTaskForm
  ...
  Caption = #1041#1088#1072#1078#1072#1083#1086#1074#1080#1095' '#1040#1083#1077#1082#1089#1072#1085#1076#1088' 351004 Lab3_4'
  ClientHeight = 437
  ClientWidth = 704
  Color = clBtnFace
  ...
  object ResultButton: TButton
    ...
    Margins.Right = 5
    Margins.Bottom = 5
    Caption = #1055#1077#1088#1074#1077#1089#1090#1080
    TabOrder = 2
