...
begin
    InstructionLabel.Caption := '1. Вам нужно ввести 2 строки которые вы хотите проверить.' + #13#10 +
                                '2. В файле должно содержаться 2 строки.' + #13#10 +
                                'Каждая записанная с новой строки.';
